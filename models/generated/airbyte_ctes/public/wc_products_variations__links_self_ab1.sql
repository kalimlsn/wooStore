...
-- depends_on: {{ ref('wc_products_variations__links') }}
{{ unnest_cte(ref('wc_products_variations__links'), '_links', adapter.quote('self')) }}
select
...
from {{ ref('wc_products_variations__links') }} as table_alias
